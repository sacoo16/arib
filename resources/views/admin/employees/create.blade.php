        ...
        <div class="card-body">
            <div class="form-group">
                <div class="alert alert-warning">
                    <h4 class="text-center">Password is default : <strong>password</strong></h4>
                </div>
            </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name"
                            id="first_name" value="{{ old('first_name', '') }}" required placeholder="First Name ..">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name"
                            id="last_name" value="{{ old('last_name', '') }}" required placeholder="Last Name ..">
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email"
                            id="email" value="{{ old('email', '') }}" required placeholder="email ..">
                        @if ($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="number" name="phone"
                            id="phone" value="{{ old('phone', '') }}" required placeholder="Phone ..">
                        @if ($errors->has('phone'))
                            <div class="invalid-feedback">
                                {{ $errors->first('phone') }}
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('salary') ? 'is-invalid' : '' }}" type="number" name="salary"
                            id="salary" value="{{ old('salary', '') }}" required placeholder="Salary ..">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="role" id="role" class="form-control">
                            ...
                            @foreach (App\Models\User::ROLES as $role_key => $role_value)
                                <option value="{{ $role_key }}" {{ $role_key == old('role') ? 'selected' : '' }}>{{ $role_value }}</option>
                            @endforeach
                        </select>
                        @if ($errors->has('role'))
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="department_id" id="department_id" class="form-control">
                            ...
                            @foreach ($departments as $department_id => $department_name)
                                <option value="{{ $department_id }}" {{ $department_id == old('department_id') ? 'selected' : '' }}>{{ $department_name }}</option>
                            @endforeach
                        </select>
